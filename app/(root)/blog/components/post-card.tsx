...
export function PostCard() {
  return (
    <Link
      href={`/blog`}
      className="group relative flex w-full transform-gpu flex-col rounded-3xl border-2 border-white bg-transparent ring-2 ring-[--post-image-bg] transition-transform hover:-translate-y-0.5"
    >
      <div className="relative aspect-[240/135] w-full"></div>
