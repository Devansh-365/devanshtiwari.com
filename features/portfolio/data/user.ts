export const USER = {
  ...
  pronouns: "he/him",
  bio: "AI Product Builder. I ship AI products end-to-end, from user research to production.",
  flipSentences: [
    "AI Product Builder",
    "Co-Founder @ Metis",
    "PM + Engineer who ships.",
    "50+ products built. Now building my own.",
  ],
  address: "Delhi NCR, India",
  phoneNumber: "",
  email: "devanshtiwari365@gmail.com",
  website: "https://devanshtiwari.me",
...
- I moved to product not because it's trendy. But because I realized knowing how to build isn't enough. You need to know what to build and why.`,
  ...
  techStack: [
    ...
    "Tailwind CSS", "PostgreSQL", "MongoDB", "Redis",
    "Docker", "Git", "Figma", "Linear",
  ],
  avatar: "/profile.png",
